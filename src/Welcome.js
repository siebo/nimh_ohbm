...
class Welcome extends React.Component {
  ...
  render() {
    ...
    <div className="mainContent">
      ...
      <p>Feedback? Suggestions? Questions? Direct them via DM on twitter to @damadam.</p>
    </div>
    );
  }
}
